          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
                Join Us & Master Automation!
              </h2>
              <p>
              Unlock your potential in the world of DevOps! Learn how to automate CI/CD pipelines, 
  master cutting-edge DevOps tools, and stay ahead in the tech industry. 
  Join our community of learners and take your skills to the next level.
            ...
            >
              <div className="flex items-center justify-end xl:justify-between">
                ...
                />
                <a
                  href="https://www.devopsplayground.online"
